...
M.config = function(config)
  ...
  config.font = wezterm.font_with_fallback {
    ...
    { family = 'JetBrainsMono Nerd Font',   weight = 500,       italic = false,       stretch = "Expanded", scale = 1.0 },
    { family = 'Hei',                       weight = 500,       stretch = 'Expanded', scale = 1.0 },
    { family = 'ComicShannsMono Nerd Font', weight = 'Regular', italic = false,       stretch = "Expanded", scale = 1.0 },
  }
